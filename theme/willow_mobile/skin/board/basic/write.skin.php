...
<section id="bo_w">
    ...
    <?php if ($is_category) { ?>
        <div class="bo_w_select write_div willow_hidden_field">
    ...
    <div class="bo_w_info write_div willow_hidden_field">
	    <?php if ($is_name) { ?>
    ...
    <div id="autosave_wrapper" class="write_div willow_autosave">
    ...
    <div class="btn_confirm write_div willow_write_actions">
        <a href="<?php echo get_pretty_url($bo_table); ?>" class="btn_cancel btn">임시저장</a>
