...
<fieldset id="faq_sch" class="willow_faq_search">
    <legend>FAQ 검색</legend>
    <form name="faq_search_form" method="get">
    <input type="hidden" name="fm_id" value="<?php echo $fm_id;?>">
    <label for="stx" class="sound_only">검색어<strong class="sound_only"> 필수</strong></label>
    <input type="text" name="stx" value="<?php echo $stx;?>" required id="stx" class="frm_input" size="15" maxlength="40" placeholder="FAQ 제목, 내용 검색">
    <button type="submit" value="검색" class="btn_submit"><span class="sound_only">검색</span></button>
    </form>
</fieldset>
...
?>
<nav id="bo_cate" class="willow_faq_cate">
    <h2>자주하시는질문 분류</h2>
    <ul id="bo_cate_ul">
        <li><a href="<?php echo $category_href;?>"<?php echo !$fm_id ? ' id="bo_cate_on"' : ''; ?>>전체보기</a></li>
        <?php
...
<div id="faq_wrap" class="faq_<?php echo $fm_id; ?> willow_faq_wrap">
    <?php // FAQ 내용
    if( count($faq_list) ){
    ?>
    <section id="faq_con">
        ...
        <ol>
            ...
            <li>
                <h3>
                    <span class="willow_board_badge"><?php echo get_text($fm['fm_subject'] ? $fm['fm_subject'] : 'FAQ'); ?></span>
                	<a href="#none" onclick="return faq_open(this);"><?php echo conv_content($v['fa_subject'], 1); ?></a>
                	<button class="tit_btn" onclick="return faq_open(this);"><span class="sound_only">열기</span></button>
                </h3>
                <div class="con_inner">
                    <strong>답변</strong>
                    <?php echo conv_content($v['fa_content'], 1); ?>
                    <button type="button" class="closer_btn"><span class="sound_only">닫기</span></button>
                </div>
            </li>
            <?php
            }
