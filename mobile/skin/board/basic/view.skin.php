...
<main class="willow_board_detail_page">
    <article class="willow_board_detail">
        <header>
            <h2><span class="willow_board_badge">공지</span><?php echo cut_str(get_text($view['wr_subject']), 120); ?></h2>
            <p>관리자 <span></span> <?php echo get_text(date('Y년 m월 d일', strtotime($view['wr_datetime']))); ?></p>
        </header>

        <div class="willow_board_detail_content">
        ...
        if($v_img_count) {
            echo '<div class="willow_board_detail_images">';
